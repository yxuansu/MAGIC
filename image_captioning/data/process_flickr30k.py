...
def copy_images(test_split, raw_image_prefix_path, copy_directory_prefix):
    ...
    for item in test_split:
        ...
        image_full_path = raw_image_prefix_path + '/' + image_name
...
if __name__ == '__main__':
    ...
    import json
    in_f = r'./raw_data/caption_datasets/dataset_flickr30k.json'
    ...
    train_save_path = save_path + '/' + r'flickr30k_train.json'
    with open(train_save_path, 'w') as outfile:
        json.dump(train_split, outfile, indent=4)

    val_save_path = save_path + '/' + r'flickr30k_val.json'
    with open(val_save_path, 'w') as outfile:
        json.dump(val_split, outfile, indent=4)

    test_save_path = save_path + '/' + r'flickr30k_test.json'
    with open(test_save_path, 'w') as outfile:
        json.dump(test_split, outfile, indent=4)

    raw_image_prefix_path = r'./raw_images/flickr30k_images/flickr30k_images/'
    copy_directory_prefix = r'./flickr30k/test_images/'
